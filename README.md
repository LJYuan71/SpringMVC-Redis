...
![浏览器请求](https://github.com/LJYuan71/SpringMVC-Redis/raw/images/请求对比图.png "浏览器请求对比图") 
##### 数据库请求图：可以通过eclipse控制台看出。只有前3次的请求连接了数据库查询,后面发起请求也不再去数据库中查找（缓存）<br>
![浏览器请求](https://github.com/LJYuan71/SpringMVC-Redis/raw/images/后台数据库查询情况.png "数据库请求情况图")
##### Redis存储请求参数和数据情况<br>
![浏览器请求](https://github.com/LJYuan71/SpringMVC-Redis/raw/images/redis请求参数存储.png "方法参数Redis")
![浏览器请求](https://github.com/LJYuan71/SpringMVC-Redis/raw/images/redis参数对应数据存储.png "方法对应参数的数据图")
## 存取测试
...
![浏览器请求](https://github.com/LJYuan71/SpringMVC-Redis/raw/images/缓存位置.png "注解使用位置选择")
